    ...
    init: function () {
        ...
        marker.addEventListener('markerFound', function () {
            ...
            if (markerId == 'marker-astronaut') {
                ...
                else if (language == 'EN') document.getElementById('title').innerHTML = 'Astronaut'

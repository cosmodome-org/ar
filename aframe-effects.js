...
/***/ (function(module, exports) {
	...
	AFRAME.registerSystem("effects", {
	    ...
	    setupPostState: function () {
	        ...
	        this.quadLeft = new THREE.Mesh(new THREE.PlaneGeometry(2, 2), null);
	        ...
	        this.quadRight = new THREE.Mesh(new THREE.PlaneGeometry(2, 2), null);
	    ...
	    renderPass: function (material, renderTarget, viewCb, forceClear){
	        ...
	        var s = renderTarget || renderer.getSize(new THREE.Vector2(0,0));
	    ...
	    isActive: function (behavior, resize) {
	        ...
	        if (resize && (this.needsResize || behavior.needsResize) && behavior.setSize) {
	            var size = scene.renderer.getSize(new THREE.Vector2(0,0));
	        ...
	        if (this.needsOverride) {
	            if(scene.onBeforeRender) {
	                scene.onBeforeRender = function (renderer, scene, camera) {
	                    var size = renderer.getSize(new THREE.Vector2(0,0)); //baba
	                    // var size = renderer.getSize(new THREE.Vector2(0,0));
